...
$allowedPages = ['dashboard', 'courses', 'modules', 'lessons', 'quizzes', 'users', 'groups', 'settings', 'updates', 'media', 'certificate'];
if (!in_array($page, $allowedPages, true)) {
    $page = 'dashboard';
}

// Only admins manage users, global settings and core updates.
if (in_array($page, ['users', 'groups', 'settings', 'updates'], true)) {
